...
createCSSRule('.warning-center', "position: absolute; width: 100%; height: 50px; top: 50%; margin-top: -25px; left: 0; display: none;", false, '');
...
addHTMLElement('img', 'warning_could_not_enter_AR.img', 'TO', 'warning_could_not_enter_AR', false);
setHTMLElemAttribute('src', 'media/warning_could_not_enter_AR.png', 'warning_could_not_enter_AR.img', false);
...
setHTMLElemAttribute('href', 'https://github.com/Armaanii-lol', 'info_button', false);
...
operateAnimation('PLAY', 'Detective_Man_Armature', 0, 41, 'LoopRepeat', 1,
        function() {}, false);


volume(loadMedia_WebAudio('sounds/hello.mp3'), 0.5);
registerOnClick('Detective_Man_Mesh', false, false, [0,1,2], function() {

  operateAnimation('STOP', 'Detective_Man_Armature', null, null, 'AUTO', 1,
          function() {}, false);

      playSound(loadMedia_WebAudio('sounds/hello.mp3'), false);

  operateAnimation('PLAY', 'Detective_Man_Armature', 42, 135, 'LoopOnce', 1,
          function() {
...
checkARMode(function() {
  eventHTMLElem('pointerup', 'enter_AR_button', false, function(event) {
    enterARMode('ORIGIN', true, function() {
      changeVis(['GROUP', 'Detective_Man_group'], false);
      ...
      changeVis(['ready_button', 'scale_percentage', 'drag_move', 'drag_scale', 'drag_rotate'], false);
    }, function() {
      changeVis(['GROUP', 'Detective_Man_group'], true);
      changeVis('prompt_move_around', false);
      setObjTransform('Detective_Man_Armature', false, 'position', createVector(0, 0, 0), false);
      setHTMLElemStyle('display', 'block', 'enter_AR_button', false);
      changeVis(['drag_move', 'drag_rotate', 'edit_button', 'drag_scale', 'scale_percentage', 'ready_button'], false);
      setObjTransform('Detective_Man_Armature', false, 'scale', [1, 1, 1], false);
  ...
  setHTMLElemAttribute('href', exportToUSDZ('Detective_Man_Mesh'), 'enter_AR_button', false);
  setHTMLElemAttribute('rel', 'ar', 'enter_AR_button', false);
  setHTMLElemAttribute('download', 'Detective_Man.usdz', 'enter_AR_button', false);
}, function() {
  eventHTMLElem('pointerup', 'enter_AR_button', false, function(event) {
...
registerOnClick('indicator_invis_plane', false, false, [0,1,2], function() {
  changeVis(['GROUP', 'Detective_Man_group'], true);
  setObjTransform('Detective_Man_Armature', false, 'position', [arHitPoint('x'), arHitPoint('y'), arHitPoint('z')], false);
  setObjDirection('Detective_Man_Armature', getObjTransform('Camera', false, 'position', 'xyz'), true, true);
  changeVis(['scale_percentage', 'drag_move', 'drag_scale', 'drag_rotate', 'ready_button', 'edit_button'], false);
  changeVis(['GROUP', 'indicator_group'], false);
}, function() {});
...
registerOnDrag('drag_move', false, [0,1,2], function() {}, function() {
  dragMoveAdv('Detective_Man_Armature', 'XY', 'WORLD', 'h*AX=dQQ*emiDBu091`k', 'A38n~@+d$b@M7+gFJ_=,');
}, function() {}, 'A38n~@+d$b@M7+gFJ_=,');

registerOnDrag('drag_rotate', false, [0,1,2], function() {}, function() {
  dragRotateAdv('Detective_Man_Armature', 'Z', 'WORLD', 'MT)8tB7,,LNg`X=ecHQI', '_/wo?-a:YB0ngY?/F_r2');
}, function() {}, '_/wo?-a:YB0ngY?/F_r2');

registerOnDrag('drag_scale', false, [0,1,2], function() {}, function() {
  dragScale('Detective_Man_Armature', 'Z', 'OH@[c8WAz,09eWo0BL1u', 'Es7QklcTz{g9YQoxKWK=');
  dragScale('Detective_Man_Armature', 'X', 'x9WKzRF]cau0T:GI7xm`', 'Es7QklcTz{g9YQoxKWK=');
  dragScale('Detective_Man_Armature', 'Y', '8jh1*;WFC})n_2H02qtZ', 'Es7QklcTz{g9YQoxKWK=');
  updateTextObj('scale_percentage', String(Math.round(toFixedPoint(getObjTransform('Detective_Man_Armature', false, 'scale', 'z'), 2) * 100)) + '%');
}, function() {}, 'Es7QklcTz{g9YQoxKWK=');
